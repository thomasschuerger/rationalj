...
- `Rational.of(String string)` (using "`<numerator>/<denominator>`", e.g. "`-431/214`", "`<integer-part>.<fractional-part>`, e.g. "`-3.14159265`", or "`<integer-part>.<fractional-part>_<repeating-fractional-part>`", e.g. "`1._3`" representing 4/3)
